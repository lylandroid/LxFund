...
public class WheelView extends ListView implements ListView.OnScrollListener, View.OnTouchListener,
    ...
    private static class ItemView extends LinearLayout {
        ...
        private void init(Context context) {
            ...
            int paddingTopBottom = SizeUtils.dp2px(context, ITEM_PADDING_TOP_BOTTOM);
            int paddingLeftRight = SizeUtils.dp2px(context, ITEM_PADDING_LEFT_RIGHT);
            setPadding(paddingLeftRight, paddingTopBottom, paddingLeftRight, paddingTopBottom);
            setGravity(Gravity.CENTER);
            int height = SizeUtils.dp2px(context, ITEM_HEIGHT);
            ...
            imageParams.rightMargin = SizeUtils.dp2px(context, ITEM_MARGIN);
