package com.framework.dialog.address;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            int height = SizeUtils.dp2px(activity, topLineHeight);
    ...
    protected View makeHeaderView() {
        ...
        int height = SizeUtils.dp2px(activity, topHeight);
        ...
        int padding = SizeUtils.dp2px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(SizeUtils.toColorStateList(cancelTextColor, pressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = SizeUtils.dp2px(activity, topPadding);
        ...
        submitButton.setTextColor(SizeUtils.toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {
