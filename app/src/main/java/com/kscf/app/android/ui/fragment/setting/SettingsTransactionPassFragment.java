    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.item_modify_pass:
                mActivity.addFragmentToActivity(mActivity,DetailsActivity.class,UpdateTransactionPassFragment.class.getName(),true);
                break;
            case R.id.item_forget_pass:
                mActivity.addFragmentToActivity(mActivity,DetailsActivity.class,ResetTransactionPassFragment.class.getName(),true);
                break;
        }
    }
